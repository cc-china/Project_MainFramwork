...
import com.grirms.crm.crm_module.adapter.BusinessManagementAdapter;
...
public class BusinessManagementActivity extends BaseActivity implements View.OnClickListener {
    private MyRadioButton mrb_sort, mrb_filtrate;
    ...
    private void setData() {
        for (int i = 0; i < 10; i++) {
            ...
            model.setItemName("空气调节系统");
            model.setCustomerCompanyName("华夏麒麟公司");
            model.setEstimatedSalesQuota("5.36W");
            model.setState("初步接洽");
            mList.add(model);
        }
    ...
    private void initView() {
        ...
        MyRadioButton mrb_map = findViewById(R.id.mrb_map);
        ...
        BusinessManagementAdapter businessManagementAdapter = new BusinessManagementAdapter(this, mList);
        recycleView.setAdapter(businessManagementAdapter);
        businessManagementAdapter.setOnItemClickListener(new BusinessManagementAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(BusinessManagementActivity.this,
                        BusinessManagementDetailsActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mrb_sort:
                ...
                break;
            case R.id.iv_select:
                startActivity(new Intent(BusinessManagementActivity.this, SearchHistoryActivity.class));
                break;
            case R.id.iv_add:
                startActivity(new Intent(BusinessManagementActivity.this, CreateBusinessManagementActivity.class));
                break;
        }
    }
}
